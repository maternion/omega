...
├── gateway/                   # runtime config (YAML + env + defaults, hot-reload), sub-config structs for all extensions
...
| `gateway`     | Implemented | Runtime config (YAML + env + defaults, hot-reload), sub-config structs for all extensions (ProviderConfig, ServerConfig, StoreConfig, SkillsConfig, MemoryConfig, LoggingConfig, CompactionConfig)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
